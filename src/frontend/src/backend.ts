...
export class Backend implements backendInterface {
    ...
    async getRoomById(arg0: bigint): Promise<Room> {
        if (this.processError) {
            try {
    ...
    async submitBooking(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: bigint): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async updateContactPhone(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateContactPhone(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateRoom(arg0: bigint, arg1: string, arg2: string, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateRoom(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
